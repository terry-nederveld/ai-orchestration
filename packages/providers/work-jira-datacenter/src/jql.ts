 ...
 * is an escape hatch that overrides construction entirely. Identical
 * construction rules to the Cloud adapter; duplicated rather than shared so
 * the two adapters can evolve independently of Cloud-only JQL features.
 */
